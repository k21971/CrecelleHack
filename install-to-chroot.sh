...
NHSUBDIR="crecellehack-1.5.0"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/crecellehack-1.5.0/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-cre150"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-cre150"
