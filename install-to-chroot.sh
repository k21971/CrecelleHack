...
NHSUBDIR="crecellehack-1.0.1"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/crecellehack-1.0.1/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-cre101"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-cre101"
