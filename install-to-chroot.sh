...
NHSUBDIR="crecellehack-1.4.1"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/crecellehack-1.4.1/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-cre141"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-cre141"
