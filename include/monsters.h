 ...
 */
    ...
    MON(NAM("winter wolf cub"), S_DOG,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_AMBUSHER | M3_TRIPPER | M3_CALLOUT,
    ...
    MON(NAM("hell hound"), S_DOG,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE | M2_STRONG,
        M3_INFRAVISIBLE | M3_TRIPPER, 14, CLR_RED, HELL_HOUND),
    ...
    MON(NAM("beholder"), S_EYE,
        ...
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS,
        M2_NOPOLY | M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE | M3_AMBUSHER,
    ...
    MON(NAM("caterwaul"), S_FELINE, 
        ...
        M2_HOSTILE, M3_INFRAVISIBLE | M3_CALLOUT, 8, CLR_GRAY, CATERWAUL),
    MON(NAM("smilodon"), S_FELINE,
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4),
          ...
          M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
          M3_INFRAVISIBLE | M3_AMBUSHER | M3_TRIPPER, 11,
          CLR_YELLOW, SMILODON),
    MON(NAM("hellcat"), S_FELINE, LVL(12, 12, 6, 0, 8), (G_HELL | G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4),
          ...
          M3_INFRAVISIBLE | M3_TRAITOR, 14, CLR_RED, HELLCAT),
    ...
    MON(NAM("gremlin"), S_GREMLIN,
        ...
        M3_INFRAVISIBLE | M3_TRAITOR | M3_TRIPPER,
        8, CLR_GREEN, GREMLIN),
    ...
    MON(NAM("gargoyle"), S_GREMLIN,
        ...
        M2_HOSTILE | M2_STRONG, M3_TRAITOR,
    ...
    MON(NAM("hobbit"), S_HUMANOID,
        ...
        M2_COLLECT, M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRIPPER,
        2, CLR_GREEN, HOBBIT),
    ...
    MON(NAM("quasit"), S_IMP,
        ...
        M2_STALK, M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRIPPER,
        7, CLR_BLUE, QUASIT),
    MON(NAM("tengu"), S_IMP,
    ...
    MON(NAM("squonk"), S_QUADRUPED,
        ...
        M2_DOMESTIC | M2_PEACEFUL, M3_INFRAVISIBLE,
        4, CLR_ORANGE, SQUONK),
    ...
    MON(NAM("giant spider"), S_SPIDER,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG, M3_AMBUSHER,
    ...
    MON(NAM("nightcrawler"), S_WORM,
        ...
        M2_HOSTILE, M3_INFRAVISION, 3, CLR_BLUE, NIGHTCRAWLER),
    ...
    MON(NAM("kestrel"), S_BAT, /* Duplicate the stats for a kestrel from Rogue */
        ...
        M2_WANDER, M3_INFRAVISIBLE, 2, CLR_BROWN, KESTREL),
    ...
    MON(NAM("hellbat"), S_BAT,  LVL(7, 22, 7, 0, 0),
        ...
        A(ATTK(AT_BITE, AD_PHYS, 1, 12), NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
 	      ...
 	      M1_FLY | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
 	      M2_WANDER | M2_HOSTILE, M3_INFRAVISIBLE, 9, CLR_ORANGE, HELLBAT),
    /*
     * Centaurs
     */
    ...
    MON(NAM("mountain centaur"), S_CENTAUR,
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_STRONG | M2_GREEDY | M2_COLLECT,
        M3_INFRAVISIBLE | M3_AMBUSHER | M3_TRAITOR,
    ...
    MON(NAM("red dragon"), S_DRAGON,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        M3_INFRAVISION | M3_INFRAVISIBLE | M3_TRAITOR,
    ...
    MON(NAM("stalker"), S_ELEMENTAL,
        ...
        M3_INFRAVISION | M3_TRAITOR | M3_TRIPPER,
        9, CLR_WHITE, STALKER),
    ...
    MON(NAMS("gnome lord", "gnome lady", "gnome leader"),
        ...
        M2_GNOME | M2_LORD | M2_COLLECT | M3_AMBUSHER,
    ...
    MON(NAM("lich"), S_LICH,
        ...
        M3_INFRAVISION | M3_AMBUSHER | M3_TRAITOR,
        14, CLR_BROWN, LICH),
    ...
    MON(NAM("master lich"), S_LICH,
        ...
        M2_UNDEAD | M2_HOSTILE | M2_MAGIC,
        M3_WANTSBOOK | M3_INFRAVISION | M3_AMBUSHER | M3_TRAITOR,
    ...
    MON(NAM("disenchanter"), S_RUSTMONST,
        ...
        M2_HOSTILE, M3_INFRAVISIBLE | M3_TRAITOR,
    ...
    MON(NAM("Vlad the Impaler"), S_VAMPIRE,
        ...
        M3_WAITFORU | M3_WANTSCAND | M3_INFRAVISIBLE | M3_TRIPPER,
    ...
    MON(NAM("barrow wight"), S_WRAITH,
        ...
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_COLLECT | M3_AMBUSHER, 0,
    ...
    MON(NAM("blood golem"), S_GOLEM,
        ...
        M2_STRONG | M2_HOSTILE, 0, 13, CLR_RED, BLOOD_GOLEM),
    ...
    MON(NAM("Dudley"), S_HUMAN,
        ...
        M3_INFRAVISIBLE, 12, HI_DOMESTIC, DUDLEY),
    ...
    MON(NAM("doppelganger"), S_HUMAN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_HOSTILE | M2_STRONG | M2_COLLECT
            | M2_SHAPESHIFTER | M3_AMBUSHER | M3_TRIPPER,
        M3_INFRAVISIBLE,
    ...
    MON(NAM("prisoner"), S_HUMAN,
        ...
        M3_INFRAVISIBLE | M3_CLOSE | M3_TRIPPER,
    ...
    MON(NAM("sergeant"), S_HUMAN,
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
                                       | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE | M3_AMBUSHER | M3_CALLOUT,
        10, CLR_RED, SERGEANT),
    ...
    MON(NAM("Medusa"), S_HUMAN,
        ...
        M3_WAITFORU | M3_INFRAVISIBLE | M3_TRIPPER,
    ...
    MON(NAM("poltergeist"), S_GHOST,
        ...
        M3_INFRAVISION | M3_INFRAVISIBLE | M3_TRAITOR | M3_TRIPPER,
...
#define SEDUCTION_ATTACKS_NO \
    ...
    MON(NAM("Grand Master"), S_HUMAN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_MALE | M2_NASTY
            | M2_MAGIC, M3_CLOSE | M3_INFRAVISIBLE | M3_CALLOUT,
    ...
    MON(NAM("Lord Sato"), S_HUMAN, LVL(20, 15, 0, 90, 20), (G_NOGEN | G_UNIQ),
        ...
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC, M3_CLOSE | M3_INFRAVISIBLE | M3_TRIPPER,
    ...
    MON(NAM("Masked Mummy"), S_MUMMY,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_PNAME | M2_MALE | M2_GREEDY
            | M2_JEWELS | M2_COLLECT | M2_MAGIC, M3_CLOSE,
    ...
    MON(NAM("hunter"), S_HUMAN,
        ...
        M1_HUMANOID | M1_SEE_INVIS | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISION | M3_INFRAVISIBLE | M3_CALLOUT,
    ...
    MON(NAM("trainee"), S_HUMAN,
        ...
        M1_HUMANOID | M1_SEE_INVIS | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISION | M3_INFRAVISIBLE | M3_CALLOUT | M3_TRIPPER,
