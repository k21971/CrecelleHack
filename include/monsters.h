 ...
 */
    ...
    MON(NAM("soldier ant"), S_ANT,
        ...
        M2_HOSTILE, 0,
        BST_ICE, 6, CLR_BLUE, SOLDIER_ANT),
    ...
    MON(NAM("hellcat"), S_FELINE, LVL(12, 12, 6, 0, 8), (G_HELL | G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4),
          ...
          M3_INFRAVISIBLE | M3_TRAITOR, BST_GRASS, 14, CLR_RED, HELLCAT),
    MON(NAM("displacer beast"), S_FELINE,
        ...
        BST_GRASS, 14, CLR_BLUE, DISPLACER_BEAST),
    /*
    ...
    MON(NAM("mumak"), S_QUADRUPED,
        ...
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE, BST_GRASS,
        7, CLR_GRAY, MUMAK),
    ...
    MON(NAM("sewer rat"), S_RODENT,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        BST_GRASS, 1, CLR_BROWN, SEWER_RAT),
    MON(NAM("giant rat"), S_RODENT,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        BST_GRASS, 2, CLR_BROWN, GIANT_RAT),
    ...
    MON(NAM("fog cloud"), S_VORTEX,
        ...
        M2_HOSTILE | M2_NEUTER, 0, BST_GRASS, 
    ...
    MON(NAM("steam vortex"), S_VORTEX,
        ...
        M1_FLY | M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_UNSOLID,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, BST_GRASS,
    ...
    MON(NAM("black hole"), S_VORTEX,
        ...
        BST_GRASS, 9, CLR_BLACK, BLACK_HOLE),
    MON(NAM("crimson death"), S_VORTEX,
        ...
        M3_INFRAVISION | M3_TRAITOR, BST_GRASS, 14, CLR_RED, CRIMSON_DEATH),
    ...
    MON(NAM("baby gray dragon"), S_DRAGON,
        ...
        BST_GRASS, 13, CLR_GRAY, BABY_GRAY_DRAGON),
    MON(NAM("baby gold dragon"), S_DRAGON,
        ...
        BST_GRASS, 13, HI_GOLD, BABY_GOLD_DRAGON),
    ...
    MON(NAM("baby red dragon"), S_DRAGON,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, M3_INFRAVISIBLE,
        BST_GRASS, 13, CLR_RED, BABY_RED_DRAGON),
    MON(NAM("baby white dragon"), S_DRAGON,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, 0,
        BST_GRASS, 13, CLR_WHITE, BABY_WHITE_DRAGON),
    MON(NAM("baby orange dragon"), S_DRAGON,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, 0,
        BST_GRASS, 13, CLR_ORANGE, BABY_ORANGE_DRAGON),
    MON(NAM("baby black dragon"), S_DRAGON,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, 0,
        BST_GRASS, 13, CLR_BLACK, BABY_BLACK_DRAGON),
    MON(NAM("baby blue dragon"), S_DRAGON,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, 0,
        BST_GRASS, 13, CLR_BLUE, BABY_BLUE_DRAGON),
    MON(NAM("baby green dragon"), S_DRAGON,
        ...
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, 0,
        BST_GRASS, 13, CLR_GREEN, BABY_GREEN_DRAGON),
    MON(NAM("baby yellow dragon"), S_DRAGON,
        ...
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, 0,
        BST_GRASS, 13, CLR_YELLOW, BABY_YELLOW_DRAGON),
    ...
    MON(NAM("red dragon"), S_DRAGON,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        M3_INFRAVISION | M3_INFRAVISIBLE | M3_TRAITOR, BST_GRASS, 
    ...
    MON(NAM("giant"), S_GIANT,
        ...
        M2_GIANT | M2_STRONG | M2_ROCKTHROW | M2_NASTY | M2_COLLECT
            | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, BST_GRASS, 8, CLR_RED, GIANT),
    ...
    MON(NAM("storm giant"), S_GIANT,
        ...
        M1_HUMANOID | M1_CARNIVORE, M2_GIANT | M2_STRONG | M2_ROCKTHROW
                                        | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_AMBUSHER | M3_CALLOUT, BST_GRASS,
    ...
    MON(NAM("minotaur"), S_GIANT,
        ...
        BST_GRASS, 17, CLR_BROWN, MINOTAUR),
    /*
     * Invisible
    ...
    MON(NAM("lich"), S_LICH,
        ...
        M3_INFRAVISION | M3_AMBUSHER | M3_TRAITOR, BST_GRASS,
        14, CLR_BROWN, LICH),
    ...
    MON(NAM("master lich"), S_LICH,
        ...
        M2_UNDEAD | M2_HOSTILE | M2_MAGIC,
        M3_WANTSBOOK | M3_INFRAVISION | M3_AMBUSHER | M3_TRAITOR, BST_GRASS,
    ...
    MON(NAM("kobold mummy"), S_MUMMY,
        ...
        M2_UNDEAD | M2_HOSTILE, M3_INFRAVISION, BST_GRASS,
    ...
    MON(NAM("gnome mummy"), S_MUMMY,
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_HOSTILE | M2_GNOME, M3_INFRAVISION, BST_GRASS,
    ...
    MON(NAM("elf mummy"), S_MUMMY,
        ...
        M2_UNDEAD | M2_HOSTILE | M2_ELF, M3_INFRAVISION, BST_GRASS,
    ...
    MON(NAM("ettin mummy"), S_MUMMY,
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_HOSTILE | M2_STRONG, M3_INFRAVISION, BST_GRASS,
    ...
    MON(NAM("ogre"), S_OGRE,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_AMBUSHER | M3_TRAITOR, BST_GRASS,
        7, CLR_BROWN, OGRE),
    ...
    MON(NAM("water troll"), S_TROLL,
        ...
        M2_STRONG | M2_STALK | M2_HOSTILE, 
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRAITOR, BST_WATER,
    ...
    MON(NAM("Olog-hai"), S_TROLL,
        ...
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
        M2_STRONG | M2_STALK | M2_HOSTILE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_AMBUSHER | M3_TRAITOR, BST_WATER,
        16, HI_LORD, OLOG_HAI),
    /*
     * Umber hulk
     */
    MON(NAM("umber hulk"), S_UMBER,
        ...
        M2_STRONG, M3_INFRAVISIBLE, BST_POTION,
    ...
    MON(NAMS("priest", "priestess", "aligned cleric"), S_HUMAN,
        ...
        M3_INFRAVISIBLE | M3_AMBUSHER, BST_GRASS,
...
#define SEDUCTION_ATTACKS_NO \
    ...
    MON(NAM("Juiblex"), S_DEMON, LVL(50, 3, -7, 65, -15),
        ...
        M2_NOPOLY | M2_DEMON | M2_STALK | M2_HOSTILE | M2_PNAME | M2_NASTY
            | M2_LORD | M2_MALE,
        M3_WAITFORU | M3_WANTSAMUL | M3_INFRAVISION, BST_WATER | BST_POTION,
    ...
    MON(NAM("djinni"), S_DEMON,
        ...
        M3_INFRAVISIBLE, BST_GRASS, 8, CLR_YELLOW, DJINNI),
    /*
     * sea monsters
     *
    ...
    MON(NAM("Master of Thieves"), S_HUMAN,
        ...
        M3_CLOSE | M3_INFRAVISIBLE | M3_AMBUSHER | M3_TRIPPER | M3_CALLOUT, BST_GRASS,
    ...
    MON(NAM("Minion of Huhetotl"), S_DEMON,
        ...
        M2_NOPOLY | M2_DEMON | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY
            | M2_COLLECT,
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISION | M3_INFRAVISIBLE, BST_BLOOD,
    ...
    MON(NAM("Chromatic Dragon"), S_DRAGON,
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISION | M3_INFRAVISIBLE, BST_GRASS,
