 ...
 */
    ...
    MON(NAM("caterwaul"), S_FELINE, 
        ...
        M2_HOSTILE, M3_INFRAVISIBLE, 8, CLR_GRAY, CATERWAUL),
    ...
    MON(NAM("gnome with the wand of death"), S_GNOME,
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(650, 100, MS_ORC, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_GNOME | M2_COLLECT | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
...
#define SEDUCTION_ATTACKS_NO \
    ...
    MON(NAM("Master of Thieves"), S_HUMAN,
        ...
        M3_CLOSE | M3_INFRAVISIBLE | M3_AMBUSHER | M3_TRIPPER,
