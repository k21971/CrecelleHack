...
POTION("enlightenment",        "swirly",  1, 0, 20, 200, CLR_BROWN,
                                                        POT_ENLIGHTENMENT),
POTION("monster detection",   "boiling",  1, 0, 40, 150, CLR_WHITE,
...
POTION("sleeping",       "effervescent",  1, 0, 40, 100, CLR_GRAY,
                                                        POT_SLEEPING),
POTION("full healing",       "volatile",  1, 0, 10, 200, CLR_BLACK,
                                                        POT_FULL_HEALING),
...
POTION("fruit juice",            "dark",  0, 0, 40,  50, CLR_BLACK,
                                                        POT_FRUIT_JUICE),
POTION("acid",               "freezing",  0, 0, 10, 250, CLR_WHITE,
                                                        POT_ACID),
POTION("oil",                  "smelly",  0, 0, 30, 250, CLR_BROWN,
                                                        POT_OIL),
/* fixed description
 */
