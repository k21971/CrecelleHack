...
#define WEAPON(name,desc,kn,mg,bi,fin,prob,wt,                          \
               cost,sdam,ldam,hitbon,stam,typ,sub,metal,color,sn)        \
    OBJECT(OBJ(name,desc),                                          \
           BITS(kn, mg, 1, 0, 0, 1, 0, 0, bi, 0, fin, typ, sub, metal),  \
           0, WEAPON_CLASS, prob, 0, wt,                            \
           cost, sdam, ldam, hitbon, stam, wt, color,sn)
...
WEAPON("dart", NoDes,
       1, 1, 0, 1, 60,   1,   2,  3,  2, 0, 3, P,   -P_DART, IRON, HI_METAL,
                                                        DART),
WEAPON("shuriken", "throwing star",
       0, 1, 0, 1, 35,   1,   5,  8,  6, 2, 3, P,   -P_SHURIKEN, IRON, HI_METAL,
                                                        SHURIKEN),
WEAPON("boomerang", NoDes,
       1, 1, 0, 1, 15,   5,  20,  9,  9, 0, 3, 0,   -P_BOOMERANG, WOOD, HI_WOOD,
                                                        BOOMERANG),
...
WEAPON("spear", NoDes,
       1, 1, 0, 0, 50,  30,   3,  6,  8, 0, 5, P,   P_SPEAR, IRON, HI_METAL,
                                                        SPEAR),
WEAPON("elven spear", "runed spear",
       0, 1, 0, 0, 10,  30,   3,  7,  8, 0, 5, P,   P_SPEAR, WOOD, HI_WOOD,
                                                        ELVEN_SPEAR),
WEAPON("orcish spear", "crude spear",
       0, 1, 0, 0, 13,  30,   3,  5,  8, 0, 5, P,   P_SPEAR, IRON, CLR_BLACK,
                                                        ORCISH_SPEAR),
WEAPON("dwarvish spear", "stout spear",
       0, 1, 0, 0, 12,  35,   3,  8,  8, 0, 6, P,   P_SPEAR, IRON, HI_METAL,
                                                        DWARVISH_SPEAR),
WEAPON("silver spear", NoDes,
       1, 1, 0, 0,  2,  36,  40,  6,  8, 0, 5, P,   P_SPEAR, SILVER, HI_SILVER,
                                                        SILVER_SPEAR),
WEAPON("javelin", "throwing spear",
       0, 1, 0, 0, 10,  20,   3,  6,  6, 0, 6, P,   P_SPEAR, IRON, HI_METAL,
                                                        JAVELIN),

/* spearish; doesn't stack, not intended to be thrown */
WEAPON("trident", NoDes,
       1, 0, 0, 0,  8,  25,   5,  6,  4, 0, 7, P,   P_TRIDENT, IRON, HI_METAL,
                                                        TRIDENT),
        /* +1 small, +2d4 large */

/* blades; all stack */
WEAPON("dagger", NoDes,
       1, 1, 0, 1, 30,  10,   4,  4,  3, 2, 4, P,   P_DAGGER, IRON, HI_METAL,
                                                        DAGGER),
WEAPON("elven dagger", "runed dagger",
       0, 1, 0, 1, 10,  10,   4,  5,  3, 2, 4, P,   P_DAGGER, WOOD, HI_WOOD,
                                                        ELVEN_DAGGER),
WEAPON("orcish dagger", "crude dagger",
       0, 1, 0, 1, 12,  10,   4,  3,  3, 2, 4, P,   P_DAGGER, IRON, CLR_BLACK,
                                                        ORCISH_DAGGER),
WEAPON("silver dagger", NoDes,
       1, 1, 0, 1,  3,  12,  40,  4,  3, 2, 4, P,   P_DAGGER, SILVER, HI_SILVER,
                                                        SILVER_DAGGER),
WEAPON("athame", NoDes,
       1, 1, 0, 1,  0,  10,   4,  4,  3, 2, 4, S,   P_DAGGER, IRON, HI_METAL,
                                                        ATHAME),
WEAPON("scalpel", NoDes,
       1, 1, 0, 1,  0,   5,   6,  3,  3, 2, 3, S,   P_KNIFE, METAL, HI_METAL,
                                                        SCALPEL),
WEAPON("knife", NoDes,
       1, 1, 0, 1, 20,   5,   4,  3,  2, 0, 4, P|S, P_KNIFE, IRON, HI_METAL,
                                                        KNIFE),
WEAPON("stiletto", NoDes,
       1, 1, 0, 1,  5,   5,   4,  3,  2, 0, 3, P|S, P_KNIFE, IRON, HI_METAL,
                                                        STILETTO),
...
WEAPON("worm tooth", NoDes,
       1, 1, 0, 0,  0,  20,   2,  2,  2, 0, 5, 0,   P_KNIFE, BONE, CLR_WHITE,
                                                        WORM_TOOTH),
WEAPON("crysknife", NoDes,
       1, 1, 0, 1,  0,  20, 100, 10, 10, 3, 3, P,   P_KNIFE, BONE, CLR_WHITE,
                                                        CRYSKNIFE),

/* axes */
WEAPON("axe", NoDes,
       1, 0, 0, 0, 40,  60,   8,  6,  4, 0, 7, S,   P_AXE, IRON, HI_METAL,
                                                        AXE),
WEAPON("battle-axe", "double-headed axe",       /* "double-bitted"? */
       0, 0, 1, 0, 10, 120,  40,  8,  6, 0, 8, S,   P_AXE, IRON, HI_METAL,
                                                        BATTLE_AXE),

/* swords */
WEAPON("short sword", NoDes,
       1, 0, 0, 1, 8,  30,  10,  6,  8, 0, 5, P,   P_SHORT_SWORD, IRON, HI_METAL,
                                                        SHORT_SWORD),
WEAPON("elven short sword", "runed short sword",
       0, 0, 0, 1, 2,  30,  10,  8,  8, 0, 4, P,   P_SHORT_SWORD, WOOD, HI_WOOD,
                                                        ELVEN_SHORT_SWORD),
WEAPON("orcish short sword", "crude short sword",
       0, 0, 0, 1, 3,  30,  10,  5,  8, 0, 5, P,   P_SHORT_SWORD, IRON, CLR_BLACK,
                                                        ORCISH_SHORT_SWORD),
WEAPON("dwarvish short sword", "broad short sword",
       0, 0, 0, 1, 2,  30,  10,  7,  8, 0, 6, P,   P_SHORT_SWORD, IRON, HI_METAL,
                                                        DWARVISH_SHORT_SWORD),
WEAPON("scimitar", "curved sword",
       0, 0, 0, 0, 15,  40,  15,  8,  8, 0, 5, S,   P_SABER, IRON, HI_METAL,
                                                        SCIMITAR),
WEAPON("silver saber", NoDes,
       1, 0, 0, 1,  6,  40,  75,  8,  8, 0, 5, S,   P_SABER, SILVER, HI_SILVER,
                                                        SILVER_SABER),
WEAPON("broadsword", NoDes,
       1, 0, 0, 0, 8,  70,  10,  4,  6, 0, 8, S,   P_BROAD_SWORD, IRON, HI_METAL,
                                                        BROADSWORD),
        /* +d4 small, +1 large */
WEAPON("elven broadsword", "runed broadsword",
       0, 0, 0, 0, 4,  70,  10,  6,  6, 0, 7, S,   P_BROAD_SWORD, WOOD, HI_WOOD,
                                                        ELVEN_BROADSWORD),
        /* +d4 small, +1 large */
WEAPON("long sword", NoDes,
       1, 0, 0, 0, 50,  40,  15,  8, 12, 0, 6, S,   P_LONG_SWORD, IRON, HI_METAL,
                                                        LONG_SWORD),
WEAPON("two-handed sword", NoDes,
       1, 0, 1, 0, 22, 150,  50, 12,  6, 0, 9, S,   P_TWO_HANDED_SWORD,
                                                            IRON, HI_METAL,
                                                        TWO_HANDED_SWORD),
        /* +2d6 large */
WEAPON("katana", "samurai sword",
       0, 0, 0, 0, 4,  40,  80, 10, 12, 1, 7, S,   P_LONG_SWORD, IRON, HI_METAL,
                                                        KATANA),
/* special swords set up for artifacts */
WEAPON("tsurugi", "long samurai sword",
       0, 0, 1, 0, 0,  60, 500, 16,  8, 2, 10, S,   P_TWO_HANDED_SWORD,
                                                            METAL, HI_METAL,
                                                        TSURUGI),
        /* +2d6 large */
WEAPON("runesword", "runed broadsword",
       0, 0, 0, 0, 0,  40, 300,  4,  6, 0, 9, S,   P_BROAD_SWORD, IRON, CLR_BLACK,
                                                        RUNESWORD),
...
WEAPON("partisan", "vulgar polearm",
       0, 0, 1, 0, 5,  80,  10,  6,  6, 0, 6, P,   P_POLEARMS, IRON, HI_METAL,
                                                        PARTISAN),
        /* +1 large */
WEAPON("ranseur", "hilted polearm",
       0, 0, 1, 0,  5,  50,   6,  4,  4, 0, 6, P,   P_POLEARMS, IRON, HI_METAL,
                                                        RANSEUR),
        /* +d4 both */
WEAPON("spetum", "forked polearm",
       0, 0, 1, 0,  5,  50,   5,  6,  6, 0, 6, P,   P_POLEARMS, IRON, HI_METAL,
                                                        SPETUM),
        /* +1 small, +d6 large */
WEAPON("glaive", "single-edged polearm",
       0, 0, 1, 1,  8,  75,   6,  6, 10, 0, 6, S,   P_POLEARMS, IRON, HI_METAL,
                                                        GLAIVE),
/* axe-type */
WEAPON("halberd", "angled poleaxe",
       0, 0, 1, 0,  8, 150,  10, 10,  6, 0, 6, P|S, P_POLEARMS, IRON, HI_METAL,
                                                        HALBERD),
        /* +1d6 large */
WEAPON("bardiche", "long poleaxe",
       0, 0, 1, 0,  4, 120,   7,  4,  4, 0, 6, S,   P_POLEARMS, IRON, HI_METAL,
                                                        BARDICHE),
        /* +1d4 small, +2d4 large */
WEAPON("voulge", "pole cleaver",
       0, 0, 1, 0,  4, 125,   5,  4,  4, 0, 6, S,   P_POLEARMS, IRON, HI_METAL,
                                                        VOULGE),
        /* +d4 both */
/* curved/hooked */
WEAPON("fauchard", "pole sickle",
       0, 0, 1, 0,  6,  60,   5,  6,  8, 0, 6, P|S, P_POLEARMS, IRON, HI_METAL,
                                                        FAUCHARD),
WEAPON("guisarme", "pruning hook",
       0, 0, 1, 0,  6,  80,   5,  4,  8, 0, 6, S,   P_POLEARMS, IRON, HI_METAL,
                                                        GUISARME),
        /* +1d4 small */
WEAPON("bill-guisarme", "hooked polearm",
       0, 0, 1, 0,  4, 120,   7,  4, 10, 0, 6, P|S, P_POLEARMS, IRON, HI_METAL,
                                                        BILL_GUISARME),
        /* +1d4 small */
/* other */
WEAPON("lucern hammer", "pronged polearm",
       0, 0, 1, 0,  5, 150,   7,  4,  6, 0, 6, B|P, P_POLEARMS, IRON, HI_METAL,
                                                        LUCERN_HAMMER),
        /* +1d4 small */
WEAPON("bec de corbin", "beaked polearm",
       0, 0, 1, 0,  4, 100,   8,  8,  6, 0, 6, B|P, P_POLEARMS, IRON, HI_METAL,
                                                        BEC_DE_CORBIN),
...
WEAPON("dwarvish mattock", "broad pick",
       0, 0, 1, 0, 13, 120,  50, 12,  8, -1, 10, B,  P_PICK_AXE, IRON, HI_METAL,
                                                        DWARVISH_MATTOCK),
WEAPON("lance", NoDes,
       1, 0, 0, 0,  4, 180,  10,  6,  8, 0, 9, P,   P_LANCE, IRON, HI_METAL,
                                                        LANCE),
...
/* bludgeons */
WEAPON("mace", NoDes,
       1, 0, 0, 0, 40,  30,   5,  6,  6, 0, 7, B,   P_MACE, IRON, HI_METAL,
                                                        MACE),
        /* +1 small */
WEAPON("morning star", NoDes,
       1, 0, 0, 0, 12, 120,  10,  4,  6, 0, 6, B,   P_MORNING_STAR, IRON, HI_METAL,
                                                        MORNING_STAR),
        /* +d4 small, +1 large */
WEAPON("war hammer", NoDes,
       1, 0, 0, 0, 15,  50,   5,  4,  4, 0, 6, B,   P_HAMMER, IRON, HI_METAL,
                                                        WAR_HAMMER),
        /* +1 small */
WEAPON("club", NoDes,
       1, 0, 0, 0, 12,  30,   3,  6,  3, 0, 5, B,   P_CLUB, WOOD, HI_WOOD,
                                                        CLUB),
WEAPON("rubber hose", NoDes,
       1, 0, 0, 1,  0,  20,   3,  4,  3, 0, 8, B,   P_WHIP, PLASTIC, CLR_BROWN,
                                                        RUBBER_HOSE),
WEAPON("quarterstaff", "staff",
       0, 0, 1, 0, 11,  40,   5,  6,  6, 0, 7, B,   P_QUARTERSTAFF, WOOD, HI_WOOD,
                                                        QUARTERSTAFF),
/* two-piece */
WEAPON("aklys", "thonged club",
       0, 0, 0, 1,  8,  15,   4,  6,  3, 0, 5, B,   P_CLUB, IRON, HI_METAL,
                                                        AKLYS),
WEAPON("flail", NoDes,
       1, 0, 0, 0, 40,  15,   4,  6,  4, 0, 6, B,   P_FLAIL, IRON, HI_METAL,
                                                        FLAIL),
        /* +1 small, +1d4 large */
