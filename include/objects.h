...
WEAPON("elven spear", "runed spear",
       0, 1, 0, 0, 10,  11,   3,  1,  6, A_DEX, A_DEX, P,   P_SPEAR, WOOD, HI_WOOD,
                                                        ELVEN_SPEAR),
WEAPON("orcish spear", "crude spear",
       0, 1, 0, 0, 13,  30,   3,  1,  6, A_STR, A_STR, P,   P_SPEAR, IRON, CLR_BLACK,
                                                        ORCISH_SPEAR),
WEAPON("dwarvish spear", "stout spear",
       0, 1, 0, 0, 12,  35,   3,  1,  6, A_STR, A_CON, P,   P_SPEAR, IRON, HI_METAL,
                                                        DWARVISH_SPEAR),
...
/* blades; all stack */
WEAPON("dagger", NoDes,
       1, 1, 0, 1, 30,  10,   4,  2,  2, A_DEX, A_STR, P,   P_DAGGER, IRON, HI_METAL,
                                                        DAGGER),
WEAPON("elven dagger", "runed dagger",
       0, 1, 0, 1, 10,   4,   4,  2,  2, A_DEX, A_DEX, P,   P_DAGGER, WOOD, HI_WOOD,
                                                        ELVEN_DAGGER),
WEAPON("orcish dagger", "crude dagger",
       0, 1, 0, 1, 12,  10,   4,  2,  2, A_STR, A_STR, P,   P_DAGGER, IRON, CLR_BLACK,
                                                        ORCISH_DAGGER),
WEAPON("athame", NoDes,
...
WEAPON("short sword", NoDes,
       1, 0, 0, 1, 8,  30,  10,  1,  6, A_STR, A_STR, P,   P_SHORT_SWORD, IRON, HI_METAL,
                                                        SHORT_SWORD),
WEAPON("elven short sword", "runed short sword",
       0, 0, 0, 1, 2,  30,  10,  1,  8, A_STR, A_DEX, P,   P_SHORT_SWORD, WOOD, HI_WOOD,
                                                        ELVEN_SHORT_SWORD),
WEAPON("orcish short sword", "crude short sword",
       0, 0, 0, 1, 3,  30,  10,  1,  5, A_STR, A_STR, P,   P_SHORT_SWORD, IRON, CLR_BLACK,
                                                        ORCISH_SHORT_SWORD),
...
WEAPON("broadsword", NoDes,
       1, 0, 0, 0, 8,  70,  10,  1, 6, A_STR, A_STR, S,   P_BROAD_SWORD, IRON, HI_METAL,
                                                        BROADSWORD),
        /* +d4 small, +1 large */
WEAPON("elven broadsword", "runed broadsword",
       0, 0, 0, 0, 4,  26,  10,  1,  6, A_STR, A_WIS, S,   P_BROAD_SWORD, WOOD, HI_WOOD,
                                                        ELVEN_BROADSWORD),
        /* +d4 small, +1 large */
...
WEAPON("katana", "samurai sword",
       0, 0, 0, 0, 4,  40,  80,  1, 12, A_STR, A_STR, S,   P_LONG_SWORD, IRON, HI_METAL,
                                                        KATANA),
...
WEAPON("runesword", "runed broadsword",
       0, 0, 0, 0, 0,  40, 300,  1,  6, A_STR, A_CHA, S,   P_BROAD_SWORD, METAL, CLR_BLACK,
                                                        RUNESWORD),
...
WEAPON("morning star", NoDes,
       1, 0, 0, 0, 12, 120,  10,  1,  6, A_STR, A_STR, B,   P_MACE, IRON, HI_METAL,
                                                        MORNING_STAR),
WEAPON("war hammer", NoDes,
       1, 0, 0, 0, 15,  50,   5,  1,  4, A_STR, A_STR, B,   P_HAMMER, IRON, HI_METAL,
                                                        WAR_HAMMER),
WEAPON("club", NoDes,
...
WEAPON("shepherd's crook", "hooked staff",
       0, 0, 1, 0,  4,  50,   5,  1,  6, A_STR, A_WIS, B,   P_QUARTERSTAFF, WOOD, HI_WOOD,
                                                        SHEPHERD_S_CROOK),                                                      
/* two-piece */
