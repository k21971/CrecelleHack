...
staticfn void fixup_starting_material(struct obj *) NONNULLARG1;
...
static const struct trobj Barbarian_0[] = {
    ...
    { CRAM_RATION, 0, FOOD_CLASS, 1, 1, 0 },
    { 0, 0, 0, 0, 0, 0 }
};
...
static const struct trobj Cave_man[] = {
    ...
    { ARMOR, 0, ARMOR_CLASS, 1, 1, UNDEF_BLESS },
    { 0, 0, 0, 0, 0, 0 }
};
...
static const struct trobj Rogue[] = {
    ...
    { ARMOR, 1, ARMOR_CLASS, 1, 1, UNDEF_BLESS },
    { POT_SICKNESS, 0, POTION_CLASS, 1, 1, 0 },
    { LOCK_PICK, 0, TOOL_CLASS, 10, 12, 0 },
    { SACK, 0, TOOL_CLASS, 1, 1, 0 },
    { 0, 0, 0, 0, 0, 0 }
};
...
static const struct trobj Valkyrie[] = {
    ...
    { ROUNDSHIELD, 3, ARMOR_CLASS, 1, 1, UNDEF_BLESS },
...
static const struct trobj Money[] =
    { { GOLD_PIECE, 0, COIN_CLASS, 1, 1, 0 },
      { 0, 0, 0, 0, 0, 0 } };
static const struct trobj Sunglasses[] =
    { { SUNGLASSES, 0, TOOL_CLASS, 1, 1, 0 },
      { 0, 0, 0, 0, 0, 0 } };
static const struct trobj Darts[] =
...
static const struct inv_sub {
    ...
    { PM_ORC, ROUNDSHIELD, ORCISH_SHIELD },
    ...
    /* { PM_DWARF, ROUNDSHIELD, DWARVISH_ROUNDSHIELD }, */
...
knows_class(char sym)
{
    ...
    for (ct = svb.bases[(uchar) sym]; ct < svb.bases[(uchar) sym + 1]; ct++) {
        ...
        if (ct == CORNUTHAUM || ct == DUNCE_CAP || ct == ROUNDSHIELD)
            continue;
        if (sym == WEAPON_CLASS) {
