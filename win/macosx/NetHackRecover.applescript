#!/usr/bin/osascript
# NetHack 5.0  NetHackRecover.applescript $NHDT-Date: 1596498329 2020/08/03 23:45:29 $  $NHDT-Branch: NetHack-3.7 $:$NHDT-Revision: 1.10 $
...
if not canceled then
	...
	considering case
		--set lastpos to offset of "/crecellehackdir" in mpath
		--set lastpos to lastpos + (length of "/crecellehackdir")
		--set rawpath to (get text 1 through lastpos of mpath) & "/recover.pl"
		--set safepath to the quoted form of rawpath
		set safepath to the quoted form of "/Library/Nethack/crecellehackdir/recover.pl"
	end considering
