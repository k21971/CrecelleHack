...
local wishtest_objects = {
   ...
   ["tonic of holy water"] = { otyp_name = "water", oclass = "!", blessed = 1, cursed = 0 },
   ["tonic of unholy water"] = { otyp_name = "water", oclass = "!", blessed = 0, cursed = 1 },
   ...
   ["cursed +3 band of increase accuracy"] = { otyp_name = "increase accuracy", oclass = "=", spe = 3, cursed = 1 },
   ["band of accuracy"] = { otyp_name = "increase accuracy", oclass = "=" },
