...
--
des.object({ id="skeleton",montype="archeologist" })
des.object({ id="corpse",montype="archeologist" })
des.object({ id="skeleton",montype="barbarian" })
des.object({ id="corpse",montype="barbarian" })
des.object({ id="skeleton",montype="caveman" })
des.object({ id="corpse",montype="cavewoman" })
des.object({ id="skeleton",montype="healer" })
des.object({ id="corpse",montype="healer" })
des.object({ id="skeleton",montype="knight" })
des.object({ id="corpse",montype="knight" })
des.object({ id="skeleton",montype="ranger" })
des.object({ id="corpse",montype="ranger" })
des.object({ id="skeleton",montype="rogue" })
des.object({ id="corpse",montype="rogue" })
des.object({ id="skeleton",montype="samurai" })
des.object({ id="corpse",montype="samurai" })
des.object({ id="skeleton",montype="tourist" })
des.object({ id="corpse",montype="tourist" })
des.object({ id="skeleton",montype="valkyrie" })
des.object({ id="corpse",montype="valkyrie" })
des.object({ id="skeleton",montype="wizard" })
