...
%.lp ""
On UNIX, Linux and macOS it is \mbox{``.crecellehackrc''} in the user's home
directory.
The file may not exist, but it is a normal ASCII text file and
can be created with any text editor.\\

%.lp ""
On Windows, the name is \mbox{``.crecellehackrc''} location in the folder
...
template for ths configuration file named \mbox{``.crecellehackrc.template''} in
\mbox{{``\%USERPROFILE\%\textbackslash NetHack\textbackslash''}}.
